...
import com.stixu.persistence.SortOrder;
...
public  abstract class QueryTemplate {
	 ...
	 * 默认的字符分割符,逗号
	 */
	private final String SPLITER_FLAG = ",";
    ...
    public void appendIn(String sql, Iterable<?> params) {
    	query.append(MessageFormat.format(QueryConstants.IN, new Object[]{sql, Joiner.on(SPLITER_FLAG).join(params)}));
    }
	 ...
	 * @param builder
	 */
	public <S> void  rebuild(S s, String sortColumn, String order, QueryBuilder<S> builder) {
    ...
    public static String buildOrderBy(String alias, String column, String order) {
    	String orderBy = " order by " + alias + "." + column + " " + order;
        return orderBy;
    }
    ...
    public String toString() {
    	return new ToStringBuilder(this)
    				  ...
    				  .append("cachable", this.cachable)
    				  .append("cacheRegion", this.cacheRegion)
